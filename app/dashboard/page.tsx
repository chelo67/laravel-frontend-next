            ...
            <div className="col-md-6">
                <div className="card p-4">
                    ...
                    <form>
                        ...
                        <div className="mb-2">
                            <Image src="/placeholder.jpg" alt="Preview" id="bannerPreview" width={100} height={100} style={{display: 'none'}} />
                        </div>
                ...
                <table className="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><Image src="/placeholder.jpg" alt="Product" width={50} height={50} /></td>
                            <td>$100</td>
                            <td>
